...
export const AboutInformation = {
    nosotros:'Somos una empresa familiar creada en el año 1995 expertosen el sector inmobiliario, nuestro enfoque es prestar la mejor experiencia en el servicio personalizado, tenemos contacto directo y cercano con nuestros clientes para brindar respuestas y asesorías oportunas.',
...
export const servicesInformation = {
    ...
    cards:[
    {
        ...
        descrip: 'Asesoría financiera con el objetivo de que el cliente realice una buena inversión.',
        btnCard: false
    },{
        id:2,
        icon:'images/icono-04.svg',
        title:'PÚBLICA CON NOSOTROS',
        descrip:'Acompañamiento en la búsqueda y toma de decisión de la compraventa de inmuebles.',
        btnCard: true
    },{
        id:3,
        icon:'images/icono-05.svg',
        title:'ADMINISTRACIÓN DE ARRIENDO',
